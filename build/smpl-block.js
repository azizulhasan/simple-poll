...
const addQuestion = () => {
  ...
  const icon_row = document.getElementById('add_question_col').firstChild.cloneNode(true);
...
wp.blocks.registerBlockType('smpl/poll', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Smple poll'),
...
function createPoll(props) {
  const [poll, setPoll] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
    id: '',
    question: '',
    question_answer: '',
    question_answers: []
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    document.querySelectorAll('.answer').forEach(item => {
      item.addEventListener('keyup', function (e) {
        setPoll(prev => {
          return { ...prev,
            question_answers: [prev.question_answers.push(e.target.value)]
          };
        });
        console.log(poll);
      });
    });
    document.querySelector('.editor-post-publish-button__button').addEventListener('click', function () {
      ...
      if (poll.id) {
        (0,_block_utilities__WEBPACK_IMPORTED_MODULE_3__.postData)(smpl_block.ajax_url, data).then(res => {
          if (res.data) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    hidden: true
  }), poll.id && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"].Control, {
    type: "text",
    id: "id",
    value: props.id,
    name: "client_id",
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"].Label, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Add Question')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"].Control, {
    type: "text",
    name: "question",
    ...
    onClick: _block_utilities__WEBPACK_IMPORTED_MODULE_3__.addQuestion,
    id: "poll.add_question"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Add Answer'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__["default"], {
    id: "add_question_col"
  }, poll.question_answers.length ? poll.question_answers.map((answer, i) => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      className: "w-100",
      controlId: 'poll.question_answer_' + i
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"].Label, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Answer ')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"].Control, {
      type: "text",
      ...
      onClick: _block_utilities__WEBPACK_IMPORTED_MODULE_3__.deleteQuestion
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Delete'))));
