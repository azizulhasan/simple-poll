...
const notify = function (message) {
  ...
  switch (type) {
    ...
    default:
      (0,react_toastify__WEBPACK_IMPORTED_MODULE_0__.toast)(message, toastConfig);
  }
};
...
/* harmony import */ var _block_Notify__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block/Notify */ "./Admin/js/block/Notify.js");
...
function simplePoll(props) {
  ...
  const submitVote = (e, answer, totalvotes) => {
    ...
    (0,_block_utilities__WEBPACK_IMPORTED_MODULE_3__.postData)(smpl_block.ajax_url, form).then(res => {
      if (res.data) {
        (0,_block_Notify__WEBPACK_IMPORTED_MODULE_4__["default"])('Your vote is recorded.');
      }
    });
  };
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
      ...
      onClick: e => submitVote(e, answer, poll.totalvotes)
